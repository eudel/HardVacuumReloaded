...
public class Field1 extends Window {
	...
	private void initialize() {
		...
		add(contentTable = new Table(skin)).width(200).height(200);
		...
		contentTable.add().width(100).height(100).row();
		contentTable.add().width(15).height(70);
		contentTable.add(lblField2).colspan(2).width(185).height(70).row();
		contentTable.add().colspan(3).width(200).height(30);
	...
	public Field1 show(Stage stage, float x, float y) {
		clearActions();
	...
	public void setField1Red(boolean red) {
		if (red == true) {
			if (isField2Red()) {
				this.setBackground("field1.red12");
			} else {
				this.setBackground("field1.red1");
			}
		} else {
			if (isField2Red()) {
				this.setBackground("field1.red2");
			} else {
				this.setBackground("field1.red");
			}
		}
		field1Red = red;
	}
