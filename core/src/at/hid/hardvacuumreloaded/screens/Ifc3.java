...
public class Ifc3 implements Screen {
	private Stage stage;
	private Table table;
	private Skin skin;
	...
	@Override
	public void show() {
		HardVacuumReloaded.debug(this.getClass().toString(), "creating Ifc3 screen");
		...
		Label lblHeading = new Label("", skin, "heading.ifc3");
		lblHeading.setBounds(0, 800, 1200, 200);

		Label lblHeadingText = new Label(HardVacuumReloaded.getLangBundle().format("Ifc3.lblHeadingText.text"), skin, "heading.text");
		lblHeadingText.setBounds(20, 815, 1155, 175);
		lblHeadingText.setAlignment(Align.center);

		Label lblMap = new Label("", skin, "map.ifc3");
		lblMap.setBounds(1200, 685, 400, 325);

		Label lblMenu = new Label("", skin, "menu.ifc3");
		...
		lblCredits.setBounds(1260, 192, 290, 80);
		...
		ibtnMenuStats.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				HardVacuumReloaded.playerProfile.setOldScreen("Ifc3");
		...
		ibtnSelectBoth.setBounds(1355, 330, 100, 105);
		...
		ibtnSelectLeft.setBounds(1355, 330, 100, 105);
		...
		ibtnSelectRight.setBounds(1355, 330, 100, 105);
	...
	@Override
	public void dispose() {
		HardVacuumReloaded.debug(this.getClass().toString(), "cleaning up Ifc3 screen");
		stage.dispose();
	}
